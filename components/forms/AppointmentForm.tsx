    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6 flex-1'>
                ...
                {type !== 'cancel' && (
                    <>
                        <CustomFormField control={form.control} fieldType={FormFieldType.SELECT} name='primaryPhysician'
                                         label='Doctor' placeholder='Select a doctor'>
                            {Doctors.map((doctor) => (
                        ...
                        <CustomFormField control={form.control} fieldType={FormFieldType.DATE_PICKER} name='schedule'
                                         label='Expected' showTimeSelect dateFormat='MM/dd/yyyy - h:mm aa'>
                        </CustomFormField>
